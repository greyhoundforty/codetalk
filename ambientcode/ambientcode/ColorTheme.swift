...
/// Supports light and dark mode with semantic color names
struct AppColorTheme {
    ...
    static let recording = Color.adaptive(
    ...
    static let inactive = Color.adaptive(
    ...
    static let focusBorder = primary
